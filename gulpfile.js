(function() {
  var CSSmin, browserSync, browserify, chalk, config, ecstatic, filter, gulp, gutil, handleError, jade, path, prefix, prettyTime, production, source, sourcemaps, streamify, stylus, uglify, watchify;
